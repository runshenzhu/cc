 ...
 */
public class RefinedTweetStructure {
    public long id;
    public long userId;
    ...
    public RefinedTweetStructure(){}

    /**
     * Recover a TweetStructure from a json line generated by ETL phase 1
     * @param jsonLine
     */
    public RefinedTweetStructure( String jsonLine ){
        Gson gson = new Gson();
        RefinedTweetStructure temp = gson.fromJson(jsonLine, this.getClass());
        this.id = temp.id;
